...
export function AcceseToMoodle_s() {
  ...
  const options = {
    ...
    onDownload: (buildHead, buildBody, columns, values) => {
      ...
      const fileName = `Cantidad accesos por usuario a la plataforma en los ultimo 6 meses ${fecha}`;
  ...
  const title = `Accesos a la plataforma en los últimos 6 meses `;
