...
export function NeverConectForCourse() {
  ...
  const options = {
    ...
    onDownload: (buildHead, buildBody, columns, values) => {
      ...
      const fileName = `Estudiantes que nunca han ingresado a sus cursos ${fecha}`;
          ...
          <CacheProvider value={muiCache}>
            <ThemeProvider theme={createTheme()}>
              <MUIDataTable
                ...
                title="Estudiantes que nunca han ingresado a sus cursos"
                data={data}
                columns={colums}
                options={options}
              />
