...
export function AlertTeacherEvaluation() {
  ...
  const colums = [
    {
      name: "faltantes",
      label: "Total Evaluaciones docentes sin presentar",
    },
    {
      name: "total",
      label: "Total Evaluaciones docentes presentadas",
    },
  ];
  ...
  const options = {
    ...
    onDownload: (buildHead, buildBody, columns, values) => {
      ...
      const fileName = `Evaluaciones docente faltanes ${fecha}`;
          ...
          <CacheProvider value={muiCache}>
            <ThemeProvider theme={createTheme()}>
              <MUIDataTable
                ...
                title="Evaluaciones docentes faltantes"
                data={data}
                columns={colums}
                options={options}
              />
