...
export function AcceseToMoodle_t() {
  ...
  const options = {
    ...
    onDownload: (buildHead, buildBody, columns, values) => {
      ...
      const fileName = `Cantidad accesos por usuario a la plataforma en los ultimos 3 meses ${fecha}`;
  ...
  const title = `Accesos a la plataforma en los últimos 3 meses `;
